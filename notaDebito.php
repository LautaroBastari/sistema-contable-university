    ...
    <div class="container border border-primary-light mt-5 bg-secondary-subtle text-dark">
        <div class="container d-flex mt-3">
            ...
            <div class="col-4 p-3 m-auto">
                <h3 class="d-flex justify-content-center alert alert-secondary"><b>Añadir Nota Débito</b></h3>
            </div>
        </div>
        ...
        <div class="container text-center" style="width: 30%;">
            ...
            <form method="POST" action="controlador/registrarDebito.php">
                <input type="hidden" name="id_venta" value="<?= $id_venta ?>">
                ...
                <button type="submit" class="btn btn-primary mb-4 mt-2" name="registrado" value="ok">Añadir Nota Débito</button>
            </form>
            ...
            <form method="POST" action="controlador/registrarDebito.php">
                ...
                <button type="submit" class="btn btn-success mb-4 mt-2" name="registrado" value="ok">Añadir Nota Débito Total</button>
